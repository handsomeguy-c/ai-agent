...
export type ExecutionMode = "react" | "plan-and-execute" | "reflection";
...
export async function listToolSchemas(): Promise<ToolSchemaVO[]> {
  return get<ToolSchemaVO[]>("/tools/list");
}

export async function callTool(
  request: ToolCallRequest,
): Promise<ToolCallResponse> {
  return post<ToolCallResponse>("/tools/call", request);
}
