...
public class AgentExecutionState {
    ...
    @Builder.Default
    private Integer maxToolCalls = 12;
    @Builder.Default
    ...
    public void increaseToolCallCount(int delta) {
        this.toolCallCount = (this.toolCallCount == null ? 0 : this.toolCallCount) + Math.max(0, delta);
        this.updatedAt = LocalDateTime.now();
    }
}
